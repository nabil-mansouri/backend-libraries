 ...
 *
 */
public class StatValuesDiff extends StatValuesAbstract {
	...
	public StatValuesDiff(StatValuesAbstract original1, StatValuesAbstract original2) {
		super();
	...
	public void compute(Comparator<String> comp) {
		...
		for (String c : categoriesL) {
			this.count.put(c, MathUtilExt.sub(this.original1.getCount(c), this.original2.getCount(c)));
		}
	}
