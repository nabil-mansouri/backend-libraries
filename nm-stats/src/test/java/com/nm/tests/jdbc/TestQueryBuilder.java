 ...
 *
 */
public class TestQueryBuilder extends JdbcQueryBuilderSelect {
	/**
	 * 
	 */
	...
	public TestQueryBuilder withActivBetween(Date from, Date to) {
		this.criterias.put(Criteria.ActivateBetween, new JdbcCriteriaList(from, to));
		return this;
	}

	public static TestQueryBuilder get() {
		return new TestQueryBuilder();
	}

	public TestQueryBuilder withCountMinAge() {
		this.selects.add(Select.Min);
		return this;
	}

	public TestQueryBuilder withCountMaxAge() {
		this.selects.add(Select.Max);
		return this;
	}

	public TestQueryBuilder withCountAvgAge() {
		this.selects.add(Select.Avg);
		return this;
	}

	public TestQueryBuilder withTownEqual(String town) {
	...
	public TestQueryBuilder withGroupByTown() {
	...
	public TestQueryBuilder withCountByNumberOfResident() {
		this.selects.add(Select.CountByNumberOfResident);
		this.groups.add(Select.LocationRef);
		return this;
	}

	public TestQueryBuilder withActivationLe(Date from) {
	...
	public TestQueryBuilder withTerminationGt(Date to) {
	...
	public TestQueryBuilder withDepartementEqual(String code) {
		this.criterias.put(Criteria.DepartementEqual, new JdbcCriteriaSingle(code));
		return this;
	}

	public TestQueryBuilder withBuisenessFinder(String id) {
	...
	public TestQueryBuilder withCategory(String id) {
		if (!Strings.isNullOrEmpty(id)) {
	...
	public TestQueryBuilder withAgeLe(Long date) {
		if (date != null) {
	...
	public TestQueryBuilder withGroupByCanton() {
		this.groups.add(Select.SelectCanton);
		this.withSelectCanton();
		return this;
	}

	public TestQueryBuilder withGroupByCantonId() {
	...
	public TestQueryBuilder withSelectCanton() {
		this.selects.add(Select.SelectCanton);
		this.withCantonCategory();
		return this;
	}

	public TestQueryBuilder withCantonCategory() {
		withAttrCategoryRef(24l);
		return this;
	}

	public TestQueryBuilder withAttrCategoryRef(Long id) {
		if (id != null) {
	...
	public TestQueryBuilder withAgeGe(Long date) {
		if (date != null) {
	...
	public TestQueryBuilder withCount() {
		this.selects.add(Select.Count);
		return this;
	}

	public TestQueryBuilder withSexeMan() {
		this.criterias.put(Criteria.Sexe, new JdbcCriteriaList(Arrays.asList("Mr", "M.")));
		return this;
	}

	public TestQueryBuilder withSexeWoman() {
	...
	public TestQueryBuilder withGroupByAge() {
