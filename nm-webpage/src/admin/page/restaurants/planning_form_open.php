<form method="get" name="slotOpenForm" ng-controller="PlanningFormOpenController" class="row">
	<input type="hidden" data-ng-model="slot.id" />
	<div class="form-group">

		<div class="row col-md-12">
			<label class="control-label col-md-12   small"> <?php echo i18("planning.reccurent.open.info"); ?>
						</label>
		</div>
		<div class="col-md-6 blank0" nb-haserror>
			...
			<div class="col-md-12">
				<div class="input-group input-group-sm" nbdatetimeall data-min-date="$$NOW">
					<input type="text" class="form-control" ng-model="slot.dateBeginPlan" ng-required="true">
	...
	<button class="btn btn-success btn-sm col-md-12" type="button" nbspinnerclick="submit()" ng-disabled="slotOpenForm.$invalid">
		<i class="fa fa-add"></i>
