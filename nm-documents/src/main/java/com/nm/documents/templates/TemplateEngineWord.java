 ...
 *
 */
public class TemplateEngineWord implements TemplateEngine {
	...
	public TemplateContext buildContext() {
		// TODO construire un dictionnary (cl�/valeur/domaine) par template
	...
	public void generate(TemplateModel template, TemplateContext context, OutputStream output) throws Exception {
		...
		new WordProcessor().process(v.getArguments(), input, output);
	}
