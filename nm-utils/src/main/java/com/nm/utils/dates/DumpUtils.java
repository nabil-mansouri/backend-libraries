...
public class DumpUtils {
	 ...
	 * using the standard {@link String#valueOf()} method. {@code CharSequences}
	...
	private static String dump(Object object, boolean isIncludingStatics, IdentityHashMap<Object, Object> visitorMap,
			int tabCount) {
