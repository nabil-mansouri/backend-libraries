	...
	public OperationCleanUnAttached(T entity, JdbcTemplate template, AssociationTypeFilterStrategy strategyType,
		...
		if (strategyUn == null) {
			...
			this.strategyOperation = new AssociationUnattachedStrategy() {
				...
				public void notAttach(Object o, JdbcOrmAssociationContext context) throws Exception {
	...
	public T operation() throws JdbcDaoException {
		try {
			...
			new JdbcOrmAssociationProcessorChecker() {
				...
				@Override
				protected void notAttach(Object o, JdbcOrmAssociationContext context) throws Exception {
					unattached.add(o);
					strategyOperation.notAttach(o, context);
				}

				@Override
				protected void notPersisted(Object o, JdbcOrmAssociationContext context) {
