 ...
 */
@Configuration
public class ConfigurationDatasHibernate implements ImportAware {
	 ...
	 */
	@Bean
	public HibernateConfigPart hibernateConfigForDatas() {
	...
	public void setImportMetadata(AnnotationMetadata importMetadata) {
		Map<String, Object> enableAttrMap = importMetadata.getAnnotationAttributes(EnableDatasModule.class.getName());
