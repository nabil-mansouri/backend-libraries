 ...
 */
@Entity
@Table(name = "nm_config_moduleconfig", schema = "mod_config", uniqueConstraints = @UniqueConstraint(columnNames = { "key", "module" }) )
public class ModuleConfig implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "seq_nm_config_moduleconfig", schema = "mod_config", sequenceName = "seq_nm_config_moduleconfig", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "seq_nm_config_moduleconfig")
	private Long id;
