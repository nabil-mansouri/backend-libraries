 ...
 */
@Entity
@Table(name = "nm_discount_tracking_lifecycle_rule_periodic")
public class DiscountTrackingLifeCycleRulePeriodic extends DiscountTrackingLifeCycleRule implements Serializable {
